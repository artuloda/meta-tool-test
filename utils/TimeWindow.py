...
# Example of usage:
tw = TimeWindow("01-01-2023 10:00:00", "01-01-2023 15:00:00", "Europe/Madrid")
print(tw)
print(tw.duration())  # Duration in minutes
print(tw.contains("01-01-2023 12:00:00"))
tw.shift(hours=1)  # Shift the time window by one hour
tw.set_tw_start("01-01-2023 00:00:00")
print(tw)
